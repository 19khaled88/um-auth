...
const getAllAdmins = async(filters:IAdminFilters,paginationOptions:IPagniationOptions):Promise<IGenericResponse<IAdmin[]>>=>{
...
const updateAdmin = async(id:string, payload:Partial<IAdmin>)=>{
    ...
    const result = await Admin.findOneAndUpdate({id}, updatedData,{new:true});
    return result
}
