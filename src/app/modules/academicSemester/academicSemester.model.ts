...
academicSemesterSchema.pre('save', async function (next) {
    try {
        ...
        if (isExist) {
            ...
            return next(new ApiError(httpStatus.CONFLICT, 'Academic semester already exists!'));
        }
        ...
        return next(new ApiError(httpStatus.INTERNAL_SERVER_ERROR, 'An unknown error occurred.'));
    }
});
